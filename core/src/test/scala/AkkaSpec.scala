/*
 * This is partially copied from:
 * Copyright (C) 2009-2018 Lightbend Inc. <https://www.lightbend.com>
 * https://github.com/akka/akka/blob/v2.5.19/akka-testkit/src/test/scala/akka/testkit/AkkaSpec.scala
 */
...
abstract class AkkaSpec(_system: ActorSystem)
  ...
  implicit val mat = ActorMaterializer.create(_system)
